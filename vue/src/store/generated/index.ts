...
import EarthMumbaiEarthMumbaiMumbai from './earth/mumbai/earth.mumbai.mumbai'
...
export default { 
  ...
  EarthMumbaiEarthMumbaiMumbai: load(EarthMumbaiEarthMumbaiMumbai, 'earth.mumbai.mumbai'),
